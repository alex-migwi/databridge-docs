import { o as objectType, i as dateType, n as numberType, j as arrayType, s as stringType, A as AstroError, U as UnknownContentCollectionError, c as createComponent, R as RenderUndefinedEntryError, u as unescapeHTML, a as renderTemplate, k as escape, l as renderUniqueStylesheet, p as renderScriptElement, q as createHeadAndContent, r as renderComponent } from './astro/server_C7Z2_luB.mjs';
...
function createGetCollection({
  ...
  return async function getCollection(collection, filter) {
    ...
    let entries = [];
    if (!Object.assign(__vite_import_meta_env__, { PORT: "3000", _: process.env._ })?.DEV && cacheEntriesByCollection.has(collection)) {
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  return html.replaceAll(CONTENT_LAYER_IMAGE_REGEX, (full, imagePath) => {
    ...
    return Object.entries({
      ...
      ...Object.assign(__vite_import_meta_env__, { PORT: "3000", _: process.env._ }).DEV ? { "data-image-component": "true" } : {}
