import { ai as REDIRECT_STATUS_CODES, A as AstroError, aj as ActionsReturnedInvalidDataError, k as escape, D as DEFAULT_404_COMPONENT } from './astro/server_C7Z2_luB.mjs';
...
function serializeActionResult(res) {
  if (res.error) {
    if (Object.assign(__vite_import_meta_env__, { PORT: "3000", CI: true, _: process.env._ })?.DEV) {
...
function deserializeActionResult(res) {
  if (res.type === "error") {
    ...
    if (Object.assign(__vite_import_meta_env__, { PORT: "3000", CI: true, _: process.env._ })?.PROD) {
